...
IDENTITY_NAME="id0001"
MAX_BATCH_SIZE=8             # pick the largest possible, start with 8 and decrease until it fits in VRAM
CHECKPOINT_PATH="latent-pose-release.pth"
OUTPUT_PATH="output_avatar/"       # a directory for outputs, will be created
RUN_NAME="run_1"  # give your run a name if you want

# Important. See the note below
TARGET_NUM_ITERATIONS=300
